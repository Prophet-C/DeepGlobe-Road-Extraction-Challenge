...
# from networks.GNMODULE import GNConvModule
...
class GNConvModule(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, 
                 dim_ratio=1, order=2, h=32, proj_out=False,
                 gf_kernel_size=3, type='gngf'):
        super().__init__()
        w = h // 2 + 1
        self.order = order
    ...
    def _init_weights(self, model):
        ...
        elif isinstance(model, (nn.LayerNorm, nn.BatchNorm2d, nn.SyncBatchNorm)):
            nn.init.constant_(model.bias, 0)
